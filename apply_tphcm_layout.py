    ...
    <div class="b-center">
        <div class="wrapper">
            ...
            <div class="m-top-20" style="display: grid; grid-template-columns: 2fr 1.2fr; gap: 20px; font-family: Arial, sans-serif;" class="columns-layout">
                ...
                <div style="background-color: #fff5f6; border: 1.5px solid #ffccd0; border-radius: 8px; padding: 20px; display: flex; flex-direction: column; justify-content: space-between; position: relative;">
...
<script>
    ...
    function renderMainCover() {
        ...
        document.getElementById('left-column-feed-container').innerHTML = `
            <div style="display: flex; gap: 15px; padding-bottom: 12px; border-bottom: 1px solid #eee; align-items: flex-start; font-family: Arial, sans-serif;">
                <a href="` + feed1.url + `" target="_blank" style="flex: 0 0 150px; width: 150px; aspect-ratio: 16/10; overflow: hidden; border-radius: 4px; display: block; background-color: #f0f0f0;">
                ...
                <div style="flex: 1;">
                    <a href="` + feed1.url + `" target="_blank" style="text-decoration: none;">
                        <h4 style="font-size: 14.5px; font-weight: bold; color: #111; margin: 0 0 6px 0; line-height: 1.4; transition: color 0.2s;" onmouseover="this.style.color='#c00000'" onmouseout="this.style.color='#111'">
                            ` + feed1.title + `
                        </h4>
                    </a>
                    <p style="font-size: 12.5px; color: #555; margin: 0 0 6px 0; line-height: 1.45; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;">
                        ` + feed1.excerpt + `
                    </p>
                    <div style="font-size: 11px; color: #999;">
                        <span>📅 ` + (feed1.date || '01/06/2026') + `</span>
                    </div>
                </div>
            </div>
            <div style="display: flex; gap: 15px; padding-bottom: 12px; border-bottom: 1px solid #eee; align-items: flex-start; font-family: Arial, sans-serif;">
                <a href="` + feed2.url + `" target="_blank" style="flex: 0 0 150px; width: 150px; aspect-ratio: 16/10; overflow: hidden; border-radius: 4px; display: block; background-color: #f0f0f0;">
                ...
                <div style="flex: 1;">
                    <a href="` + feed2.url + `" target="_blank" style="text-decoration: none;">
                        <h4 style="font-size: 14.5px; font-weight: bold; color: #111; margin: 0 0 6px 0; line-height: 1.4; transition: color 0.2s;" onmouseover="this.style.color='#c00000'" onmouseout="this.style.color='#111'">
                            ` + feed2.title + `
                        </h4>
                    </a>
                    ...
                    <div style="font-size: 11px; color: #999;">
                        <span>📅 ` + (feed2.date || '01/06/2026') + `</span>
                    </div>
                </div>
            </div>
            <div style="display: flex; gap: 15px; padding-bottom: 12px; border-bottom: 1px solid #eee; align-items: flex-start; font-family: Arial, sans-serif;">
                <a href="` + feed3.url + `" target="_blank" style="flex: 0 0 150px; width: 150px; aspect-ratio: 16/10; overflow: hidden; border-radius: 4px; display: block; background-color: #f0f0f0;">
                ...
                <div style="flex: 1;">
                    <a href="` + feed3.url + `" target="_blank" style="text-decoration: none;">
                        <h4 style="font-size: 14.5px; font-weight: bold; color: #111; margin: 0 0 6px 0; line-height: 1.4; transition: color 0.2s;" onmouseover="this.style.color='#c00000'" onmouseout="this.style.color='#111'">
                            ` + feed3.title + `
                        </h4>
                    </a>
                    ...
                    <div style="font-size: 11px; color: #999;">
                        <span>📅 ` + (feed3.date || '01/06/2026') + `</span>
                    </div>
                </div>
            </div>
            <div style="display: flex; gap: 15px; align-items: flex-start; font-family: Arial, sans-serif;">
                <a href="` + feed4.url + `" target="_blank" style="flex: 0 0 150px; width: 150px; aspect-ratio: 16/10; overflow: hidden; border-radius: 4px; display: block; background-color: #f0f0f0;">
                    <img src="` + feed4.image + `" style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.3s;" onmouseover="this.style.transform='scale(1.03)'" onmouseout="this.style.transform='none'">
                </a>
                <div style="flex: 1;">
                    <a href="` + feed4.url + `" target="_blank" style="text-decoration: none;">
                        <h4 style="font-size: 14.5px; font-weight: bold; color: #111; margin: 0 0 6px 0; line-height: 1.4; transition: color 0.2s;" onmouseover="this.style.color='#c00000'" onmouseout="this.style.color='#111'">
                            ` + feed4.title + `
                        </h4>
                    </a>
                    ...
                    <div style="font-size: 11px; color: #999;">
                        <span>📅 ` + (feed4.date || '01/06/2026') + `</span>
                    </div>
                </div>
            </div>
        `;
