...
<script>
    ...
    function renderMainCover() {
        ...
        const spot1 = rightPool[0] || hanoiArticles[3];
        const spot2 = rightPool[1] || hanoiArticles[4];
        const spot3 = rightPool[2] || hanoiArticles[5];
        const spot4 = rightPool[3] || hanoiArticles[6];
