...
with open('c:/Users/Admin/Documents/Work_Folders/4_Hoat_Dong_Ca_Nhan/LANDING PAGE THƯỜNG TRÚ/Thu_Nghiem_03_06/tphcm_dongnambo_consolidated.json', 'r', encoding='utf-8') as f:
                ...
                <div style="background-color: #ffffff; border: 1px solid #e3e3e3; border-radius: 8px; overflow: hidden; display: flex; flex-direction: column; justify-content: space-between; position: relative; min-height: 380px; box-sizing: border-box;">
                    ...
                    <div style="padding: 15px; display: flex; flex-direction: column; gap: 8px; flex-grow: 1; justify-content: space-between;">
                        <div>
                            ...
                            <p style="margin: 0; font-size: 12px; color: #444; line-height: 1.45;">Đón hè rực rỡ cùng hàng ngàn ưu đãi giải nhiệt từ siêu thị Shopee TP.HCM & Đông Nam Bộ! Tiết kiệm lên tới 20% các mặt hàng tươi sống, thịt sạch & rau sạch mỗi ngày!</p>
                        </div>
...
# Save as Thu_Nghiem_03_06/demo_landing_page_tphcm_ads.html
ads_html_path = 'c:/Users/Admin/Documents/Work_Folders/4_Hoat_Dong_Ca_Nhan/LANDING PAGE THƯỜNG TRÚ/Thu_Nghiem_03_06/demo_landing_page_tphcm_ads.html'
with open(ads_html_path, 'w', encoding='utf-8') as f:
    f.write(full_html_content)

# Save as Thu_Nghiem_03_06/tphcm_index_ads.html for easy Vercel routing
index_ads_path = 'c:/Users/Admin/Documents/Work_Folders/4_Hoat_Dong_Ca_Nhan/LANDING PAGE THƯỜNG TRÚ/Thu_Nghiem_03_06/tphcm_index_ads.html'
with open(index_ads_path, 'w', encoding='utf-8') as f:
    f.write(full_html_content)

# Overwrite original root page Thu_Nghiem_03_06/demo_landing_page_tphcm.html
orig_html_path = 'c:/Users/Admin/Documents/Work_Folders/4_Hoat_Dong_Ca_Nhan/LANDING PAGE THƯỜNG TRÚ/Thu_Nghiem_03_06/demo_landing_page_tphcm.html'
with open(orig_html_path, 'w', encoding='utf-8') as f:
    f.write(full_html_content)

# Overwrite Thu_Nghiem_03_06/tphcm_index.html for default Vercel routing
index_path = 'c:/Users/Admin/Documents/Work_Folders/4_Hoat_Dong_Ca_Nhan/LANDING PAGE THƯỜNG TRÚ/Thu_Nghiem_03_06/tphcm_index.html'
