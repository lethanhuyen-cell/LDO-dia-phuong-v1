    ...
    <div class="b-center">
        <div class="wrapper">
                        ...
                        <div class="premium-card" style="box-sizing: border-box; display: flex; flex-direction: column; justify-content: space-between; margin-top: 15px;">
                            <div>
                                <div style="font-size: 13.5px; font-weight: bold; color: #002d62; text-transform: uppercase; border-bottom: 2px solid #002d62; padding-bottom: 6px; margin-bottom: 12px; display: flex; justify-content: space-between; align-items: center;">
                                    <span>📊 Khảo sát Dư luận Địa phương</span>
                                ...
                                <div id="poll-container">
                                    <h4 style="margin: 0 0 12px 0; font-size: 12.5px; font-weight: bold; color: #333; line-height: 1.45;">Bạn ủng hộ việc tiếp tục mở rộng thêm các tuyến phố đi bộ vào cuối tuần tại TP.HCM & Đông Nam Bộ không?</h4>
            ...
            <div class="m-top-20" style="background-color: #f7f7f7; padding: 20px; border-radius: 8px; border: 1px solid #e3e3e3; font-family: Arial, sans-serif;">
                ...
                <div class="sidebar-col" style="position: sticky; top: 15px; align-self: start; display: flex; flex-direction: column; gap: 20px;">
...
# Save as Thu_Nghiem_03_06/tphcm_index_opt1_ads.html
ads_html_path = 'c:/Users/Admin/Documents/Work_Folders/4_Hoat_Dong_Ca_Nhan/LANDING PAGE THƯỜNG TRÚ/Thu_Nghiem_03_06/tphcm_index_opt1_ads.html'
with open(ads_html_path, 'w', encoding='utf-8') as f:
    f.write(full_html_content)

# Save as Thu_Nghiem_03_06/tphcm_index_opt1_ads2.html for easy Vercel routing
index_ads_path = 'c:/Users/Admin/Documents/Work_Folders/4_Hoat_Dong_Ca_Nhan/LANDING PAGE THƯỜNG TRÚ/Thu_Nghiem_03_06/tphcm_index_opt1_ads2.html'
with open(index_ads_path, 'w', encoding='utf-8') as f:
    f.write(full_html_content)

# Overwrite original root page Thu_Nghiem_03_06/tphcm_index_opt1_demo.html
orig_html_path = 'c:/Users/Admin/Documents/Work_Folders/4_Hoat_Dong_Ca_Nhan/LANDING PAGE THƯỜNG TRÚ/Thu_Nghiem_03_06/tphcm_index_opt1_demo.html'
with open(orig_html_path, 'w', encoding='utf-8') as f:
    f.write(full_html_content)

# Overwrite Thu_Nghiem_03_06/tphcm_index_opt1.html for default Vercel routing
index_path = 'c:/Users/Admin/Documents/Work_Folders/4_Hoat_Dong_Ca_Nhan/LANDING PAGE THƯỜNG TRÚ/Thu_Nghiem_03_06/tphcm_index_opt1.html'
