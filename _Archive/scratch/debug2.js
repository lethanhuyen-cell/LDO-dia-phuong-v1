const window = {};
const document = { getElementById: function(id) { return {style:{}}; }, querySelectorAll: function() { return []; }, addEventListener: function(e, cb) { cb(); } };
window.addEventListener = function(e, cb) { cb(); };
