...
const window = global;
const document = {
    createElement: function(tag) { return { value: '', textContent: '', appendChild: function(){} }; },
    ...
    addEventListener: function(event, callback) {
        if(event === 'DOMContentLoaded') {
            try { callback(); } catch(e) { console.error('CRASH IN DOMContentLoaded:', e.stack); }
        }
    }
};
window.addEventListener = document.addEventListener;
const localStorage = { getItem: function(){ return null; }, setItem: function(){} };
const fetch = function() { return Promise.resolve({ json: function() { return Promise.resolve({}); } }); };
