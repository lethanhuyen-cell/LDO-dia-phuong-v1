    ...
    function renderCategoryColumns() {
        ...
        row1Categories.forEach(cat => { row1Html += makeColumnHtml(cat); } catch(e) { console.error('RUNTIME ERROR:', e); }
        ...
        row2Categories.forEach(cat => { row2Html += makeColumnHtml(cat); } catch(e) { console.error('RUNTIME ERROR:', e); }
